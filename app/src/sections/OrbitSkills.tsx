...
const skillsData = {
  ...
  backend: [
    ...
    { name: "Node.js", icon: Server, color: "#092E20" },
    { name: "Django REST", icon: Server, color: "#339933" },
...
const OrbitRing = ({
  ...
  return (
    <motion.div
      ...
      // Removed onMouseEnter/Leave from here - moved to individual skills
    >
      {/* Orbit Path */}
      <div
        className="absolute rounded-full border border-dashed border-white/10"
      ...
      {skills.map((skill, index) => {
        ...
        return (
          <motion.div
            key={skill.name}
            className="absolute pointer-events-auto" // Added pointer-events-auto to capture events
            style={{
              x,
              y,
            }}
            ...
            onMouseEnter={() => {
              ...
              setIsPaused(true); // Pause ring on skill hover
            }}
            onMouseLeave={() => {
              setHoveredIndex(null);
              setIsPaused(false); // Resume ring on leave
            }}
          >
            {/* Counter-rotation to keep icon upright */}
            <motion.div
            ...
            >
              ...
              >
                ...
                {/* Tooltip - Now works for all rings! */}
                <motion.div
                  initial={{ opacity: 0, y: 10, scale: 0.8 }}
                  animate={{
                    opacity: isHovered ? 1 : 0,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 sm:mb-24">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            My technology stack spans frontend, backend, AI integration, and
            DevOps. Hover over the orbits to pause and explore each skill.
          </p>
        </motion.div>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { name: "AI/ML", color: "#6366f1", count: skillsData.ai.length },
            {
              name: "DevOps",
              color: "#2496ED",
              count: skillsData.devops.length,
            },
          ].map((category, index) => (
            <motion.div
              key={category.name}
