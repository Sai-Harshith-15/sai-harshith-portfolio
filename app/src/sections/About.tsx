...
const highlights = [
  {
    ...
    description:
      "Expert in CrewAI, RAG systems, and LLM integration with 35-40% industry growth rate.",
    color: "#6366f1",
  },
  {
    icon: Code,
    ...
    description:
      "2+ years building scalable applications with React, Python, and modern frameworks.",
    color: "#06b6d4",
  },
  {
    icon: Rocket,
    title: "Fast Learner",
    description:
      "Rapidly adapting to emerging technologies like LangChain, LangGraph, and Vector DBs.",
    color: "#ec4899",
  },
  {
    icon: Target,
    ...
    description:
      "Building end-to-end solutions from concept to production deployment.",
    color: "#3b82f6",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Positioned at the intersection of Full Stack Development and AI
            Integration, I bring a unique combination of traditional software
            engineering skills and cutting-edge AI capabilities.
          </p>
        </motion.div>
        ...
        >
          ...
          <blockquote className="relative z-10">
            <p className="text-xl sm:text-2xl md:text-3xl font-display font-medium text-white mb-6 leading-relaxed">
              "The market is rewarding developers who can bridge traditional
